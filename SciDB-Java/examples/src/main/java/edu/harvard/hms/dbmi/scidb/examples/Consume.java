...
public class Consume {
	...
	public static void main(String[] args) {
		...
		SciDBOperation listOperation = sciDB.list(SciDBListElement.FUNCTIONS);
		
		
		SciDBOperation consumeOperation = sciDB.consume(listOperation);
		System.out.println(consumeOperation.toAFLQueryString());
