...
//		SciDBOperation avgOperation = SciDB.avgFunction("val");
		
		SciDBOperation avgOperation = new SciDBOperation("avg");
		avgOperation.setCommandString("val");

		SciDBOperation crossJoinOperation = sciDB.cumulate(array, "col", avgOperation);
