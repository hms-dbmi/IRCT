...
//		sciDB.connect("http://scidb.aws.dbmi.hms.harvard.edu:8080");
		...
		SciDBOperation buildOperation = sciDB.build(newArray, "1");
		System.out.println(buildOperation.toAFLQueryString());
