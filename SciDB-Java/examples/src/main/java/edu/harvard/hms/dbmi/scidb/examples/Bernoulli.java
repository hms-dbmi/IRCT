...
public class Bernoulli {
	...
	public static void main(String[] args) {
		...
		SciDBArray newArray = new SciDBArray("bernoulli_array");
		...
		SciDBOperation bernoulliOperation = sciDB.bernoulli(newArray,0.5,15);

		System.out.println(bernoulliOperation.toAFLQueryString());
