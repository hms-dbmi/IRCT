...
public class AvgRank {
	...
	public static void main(String[] args) {
		System.out.println("Avg_Rank Example");
		SciDB sciDB = new SciDB();
		// sciDB.connect("http://scidb.aws.dbmi.hms.harvard.edu:8080");

		SciDBArray newArray = new SciDBArray("rank_array");
		...
		SciDBOperation avgRankOperation = sciDB.avgRank(newArray,"val","i");

		System.out.println(avgRankOperation.toAFLQueryString());
