...
public class RightOuterHashJoinTest {
	...
	private ResultSet createComparator() throws ResultSetException,
		...
		return JoinTestUtil.createResultSet(new Column[] { leftIdColumn, leftNameColumn,
				rightIdColumn, rightAgeColumn }, new Object[] { 1, "Jeremy", 1, 20, 2, "James", 2, 30, null, null, 5, 10 });
	}
