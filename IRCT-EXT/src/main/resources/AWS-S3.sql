...
insert into Event_parameters(id, name, value) values(@S3BeforeGetResultId, 'resultDataFolder', '');
insert into Event_parameters(id, name, value) values(@S3AfterSaveResultId, 'resultDataFolder', '');