 ...
 */
@Stateful
public class OLD_QueryController {
	 ...
	 */
	public Long addSelectClause(Long sqId, Entity parameter, Resource resource)
	...
	public Long addJoinClause(Long sqId1, Long sqId2, String joinType,
			Entity fieldId1, Entity fieldId2, String relationship, Long joinId)
...
//		checkSubQueryJoinSupport(sq2, jt, fieldId2, relationship);
	 ...
	 */
	public Long addWhereClause(Long sqId, String logicalOperator, Entity field,
