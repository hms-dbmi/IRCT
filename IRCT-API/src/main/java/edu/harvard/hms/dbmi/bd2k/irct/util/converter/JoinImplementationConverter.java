...
/**
 * Converts a JoinImplementation to a String representation of the class to allow for
 ...
 */
@Converter
public class JoinImplementationConverter implements
	...
	public JoinImplementation convertToEntityAttribute(String className) {
		if (className != null) {
			ClassLoader cl = JoinImplementationConverter.class.getClassLoader();
			try {
