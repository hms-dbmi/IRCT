...
/**
 * The select operation type class provides a way for the IRCT application to
 * keep track of which select operations can be used.
 * 
 * @author Jeremy R. Easton-Marks
 *
 */
@Entity
public class SelectOperationType implements Serializable {
	...
	public JsonObject toJson(int depth) {
		...
		predicateTypeJSON.add("operationName", getName());
	...
	/**
	 * Returns a list of data types that this predicate can be run on. An empty
	 * list means all data types.
	 * 
	...
	/**
	 * Sets the list of data type that this predicate can be run on. An empty
	 * list means all data types.
	 * 
	 * @param dataTypes
	...
	/**
	 * Returns a list of paths that restrict what fields this predicate can be
	 * run on. An empty list means all paths.
	 * 
	 * @return the paths
	 */
	...
	/**
	 * Sets a list of paths that restrict what fields this predicate can be run
	 * on. An empty list means all paths.
	 * 
	 * @param paths
	 *            the paths to set
	 */
