-- This script will create a new datasource in the MySQL database, called `i2b2-nhanes`
-- This setup uses `localhost`, so it is assumed, that the service runs on the same host
-- as the I2B2 instance it is connecting to.
--
set @resourceName = 'i2b2-tm-dev';
set @resourceImplementingInterface = 'edu.harvard.hms.dbmi.bd2k.irct.ri.i2b2.I2B2XMLResourceImplementation';

set @resourceURL = 'https://localhost/i2b2-services/';
set @domain = 'i2b2demo';
set @userName = 'Demo';
